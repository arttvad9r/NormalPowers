...
ROUTING_SECTION = """NormalPowers is the planning-first software workflow for this profile when it acts as planner/orchestrator.
...
10. Encode verification in the task graph. Prefer a downstream acceptance/QA task for multi-task projects; for a single bounded task, same-card `kanban_request_review` is acceptable. Do not combine both review models for the same work.
